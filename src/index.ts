...
if (!HIVE_URL || !HIVE_TOKEN) {
  console.error("Error: HIVE_URL and HIVE_TOKEN environment variables are required.");
  console.error("");
  console.error("  export HIVE_URL=https://your-hive-instance.com");
  console.error("  export HIVE_TOKEN=your-api-token");
  console.error("  npx @oatclaw/hive-mcp");
  process.exit(1);
}
